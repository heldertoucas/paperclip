...
- **Key Pattern**: Hotkey-triggered capture → write to `obsidian-ht/00-inbox/pc/`
...
## Code Standards
- Write destination: `obsidian-ht/00-inbox/pc/` only — no files outside app dir and mapped vault
